...
// Note: 'voice' was missing here before this task too (pre-existing gap,
...
const KNOWN_MAIN_TABS: SettingsMainTab[] = ['agents', 'appearance', 'chatInput', 'git', 'api', 'voice', 'presets', 'memory', 'tasks', 'browser', 'notifications', 'plugins', 'about'];
