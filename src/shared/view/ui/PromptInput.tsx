...
>(({ className, ...props }, ref) => (
  <textarea
    ...
    className={cn(
      'chat-input-placeholder block max-h-[min(var(--composer-max-h,40vh),var(--composer-room,100vh))] w-full resize-none overflow-y-auto bg-transparent px-4 py-2 text-sm leading-6 text-foreground placeholder-muted-foreground/50 focus:outline-none sm:max-h-[300px]',
      className
    )}
    {...props}
  />
