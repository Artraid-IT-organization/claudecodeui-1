 ...
 * показывает вывод действия свёрнутым; 16 тыс. знаков — около пяти экранов
 * телефона. При 64 тыс. порция всё ещё весила 1,9 МБ: одно чтение файла даёт
 * четыре такие строки (вызов, результат и их копии). Живой поток не режется.
 */
const HISTORY_TOOL_STRING_LIMIT = 16_000;
